...
type Modal = 'account' | 'transaction' | 'transfer' | 'checkin' | 'whatif' | 'commitment' | 'debt' | 'debt-event' | 'receivable' | 'receivable-event' | 'investment' | 'reserve' | 'workspace' | 'space' | 'import' | null;
